...
<html lang="en">
	<head>
	    ...
	    <title>Electronic Ecommerce Store Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/OIP.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/a.jpg);">
			</div><!-- /.item -->
		</div>
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/b.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
...
<?php
$smartphones=mysqli_query($con,"select * from products where category=5");
